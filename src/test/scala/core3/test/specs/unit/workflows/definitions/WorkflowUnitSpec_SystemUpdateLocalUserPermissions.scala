...
class WorkflowUnitSpec_SystemUpdateLocalUserPermissions extends AsyncUnitSpec {
  ...
  private val workflows = Vector(SystemCreateLocalUser, SystemUpdateLocalUserPermissions)
  ...
  "A SystemUpdateLocalUserPermissions workflow" should "successfully update users" in {
    fixture =>
      ...
      for {
        ...
        updatedUsers.head.permissions should be(updatedPermissions)
