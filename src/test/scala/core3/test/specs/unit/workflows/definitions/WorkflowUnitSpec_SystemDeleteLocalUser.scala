...
class WorkflowUnitSpec_SystemDeleteLocalUser extends AsyncUnitSpec {
  ...
  private val workflows = Vector(SystemCreateLocalUser, SystemDeleteLocalUser)
  ...
  "A SystemDeleteLocalUser workflow" should "successfully delete users" in {
    fixture =>
      ...
      for {
        ...
        updatedUsers should have size 0
      }
  }
}
